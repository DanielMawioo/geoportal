...
class Shamba(models.Model):
    ...
    soil_type = models.CharField(max_length=254, null =True)
...
class KiambuDivision(models.Model):
    ...
    varname_3 = models.CharField(max_length=254, null =True)
    nl_name_3 = models.CharField(max_length=254, null =True)
    hasc_3 = models.CharField(max_length=254, null =True)
    type_3 = models.CharField(max_length=254, null =True)
    engtype_3 = models.CharField(max_length=254, null =True)
    validfr_3 = models.CharField(max_length=254, null =True)
    validto_3 = models.CharField(max_length=254, null =True)
    remarks_3 = models.CharField(max_length=254, null =True)
    shape_leng = models.FloatField()
    shape_area = models.FloatField()
    geom = models.PolygonField(srid=4326)
...
class KiambuLocation(models.Model):
    ...
    varname_4 = models.CharField(max_length=254, null =True)
    type_4 = models.CharField(max_length=254, null =True)
    engtype_4 = models.CharField(max_length=254, null =True)
    validfr_4 = models.CharField(max_length=254, null =True)
    validto_4 = models.CharField(max_length=254, null =True)
    remarks_4 = models.CharField(max_length=254, null =True)
    shape_leng = models.FloatField()
    shape_area = models.FloatField()
    geom = models.MultiPolygonField(srid=4326)
