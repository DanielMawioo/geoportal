...
def data(request):
    template = 'mysite/lookupdata.html'
    title = 'Shamba'
...
def registershamba(request):
    template = 'mysite/registershamba.html'
    title = 'Register'
...
def update_payment(request):
    template = 'mysite/update-payment.html'
...
def discardshamba(request):
    template = 'mysite/discardshamba.html'
    title = 'Discard'
...
def changeowner(request):
    template = 'mysite/changeowner.html'
    title = 'Change'
    context = {
        'title': title,
    }
...
def statistics(request):
    template = 'mysite/statistics.html'
    title = 'Statistics'
