# Generated by Django 3.1.2 on 2020-10-13 08:12
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('shape_area', models.FloatField()),
                ('geom', django.contrib.gis.db.models.fields.MultiPolygonField(srid=4326)),
                ('type_of_lease', models.CharField(choices=[('Freehold', 'Free-hold'), ('Leasehold', 'Leasehold')], max_length=20, null=True)),
                ('zone', models.CharField(choices=[('Industrial', 'Industrial'), ('Commercial', 'Commercial'), ('Residential', 'Residential')], max_length=20, null=True)),
                ('period_of_lease', models.IntegerField(null=True)),
                ('land_use', models.CharField(choices=[('Agricultural', 'Agricultural'), ('Bare_Land', 'Bare_Land')], max_length=20, null=True)),
                ('shamba_owner', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='mysite.ownershipinfo')),
            ],
        ),
        migrations.CreateModel(
            name='PaymentInfo',
            fields=[
                ...
                ('paid_for', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='mysite.ownershipinfo')),
            ],
        ),
        migrations.CreateModel(
            name='LandOwner',
            fields=[
                ...
                ('id_number', models.IntegerField()),
                ('land', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='mysite.shamba')),
            ],
        ),
    ]
